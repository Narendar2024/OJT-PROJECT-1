...
body {
	...
	/* Change 'background.jpg' to your actual image path */
						...
						<div class="row mb-5">
							...
							<div class="col-md-3">
								<div class="dbox w-100 text-center">
									...
									<div class="text">
										<p>
											<span>Address:</span> <a
												href="https://www.google.com/maps/place/National+Skill+Training+Institute/@17.4030585,78.5121307,17z/data=!3m1!4b1!4m6!3m5!1s0x3bcb99a144bf6705:0xb8446074a37b8752!8m2!3d17.4030534!4d78.5147056!16s%2Fg%2F1tknhxp7?entry=ttu&g_ep=EgoyMDI0MDgyMS4wIKXMDSoASAFQAw%3D%3D"
												target="_blank"> Hyderabad Telangana, India</a>
										</p>
									</div>
								</div>
							</div>
							<div class="col-md-3">
								<div class="dbox w-100 text-center">
									...
									<div class="text">
										<p>
											<span>Phone:</span> <a href="tel://1234567920">+ 91
												7013728117</a>
										</p>
									</div>
								</div>
							...
							<div class="col-md-3">
								<div class="dbox w-100 text-center">
									...
									<div class="text">
										<p>
											<span>Email:</span> <a
												href="mailto:prasadshivasai22@gmail.com">manaakitanga@gmail.com</a>
										</p>
									</div>
								</div>
							</div>
							<div class="col-md-3">
								<div class="dbox w-100 text-center">
									...
									<div class="text">
										<p>
											<span>Website:</span> <a href="#"><br> Manaakitanga</a>
										</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-8">
								<div class="contact-wrap w-100 p-md-5 p-4">
									...
									<div id="form-message-success" class="mb-4"
										style="display: none">Your message was sent, thank you!</div>
									<form method="POST" action="ContactServlet" id="contactForm"
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label class="label" for="phone">Phone Number</label> <input
											...
											<div class="col-md-6">
												<div class="form-group">
													<label class="label" for="query">Query Type</label> <select
														class="form-control" name="query" id="query" required>
