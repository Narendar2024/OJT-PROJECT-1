...
<body>
	...
	<div class="container mt-4">
		...
		<table class="table table-bordered" data-category="books">
			<thead>
				<tr>
					<th>Donor Name</th>
					<th>Book Name</th>
		...
		<table class="table table-bordered" data-category="food">
			<thead>
				<tr>
					<th>Donor Name</th>
					<th>Food Type</th>
		...
		<table class="table table-bordered" data-category="money">
			<thead>
				<tr>
					<th>Donor Name</th>
					<th>Amount</th>
		...
		<table class="table table-bordered" data-category="ngo">
			<thead>
				<tr>
					<th>Donor Name</th>
					<th>Search NGO</th>
		...
		<table class="table table-bordered" data-category="other">
			<thead>
				<tr>
					<th>Donor Name</th>
					<th>Item Name</th>
